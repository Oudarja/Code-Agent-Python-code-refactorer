...
def get_all_branches(owner, repo):
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            return None, f"Repository not found. Please provide a valid repository link: {res.status_code}"  # Repo not found
        else:
            return None, f"Github API Error: {res.status_code}"  # Unexpected error
    except requests.exceptions.RequestException:
        return None, "Network error" # Network or other request error
...
def get_owner_and_repo(repo_url: str) -> Dict[str, str]:
    ...
    Example: https://github.com/openai/gpt-4 -> {"owner": "openai", "repo": "gpt-4"}
    """
